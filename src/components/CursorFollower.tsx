      ...
      <>
        {!mobileActive ? (
          <button
            ...
            className="fixed bottom-6 left-1/2 z-[80] -translate-x-1/2 rounded-full bg-[#1F1D1A]/90 px-5 py-2.5 text-xs tracking-[0.18em] text-[#F4EDE2] shadow-xl backdrop-blur-md border border-white/10"
          >
            TAP TO ROTATE 3D
          </button>
        ) : (
          <button
            ...
            className="fixed top-4 right-4 z-[80] rounded-full bg-white/90 p-3 text-[#1F1D1A] shadow-xl backdrop-blur"
